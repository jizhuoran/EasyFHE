...
def mask_mod_n(c,n,padding,max_slots,cryptoContext):
    ...
    x = torch.tensor(mask, device="cuda")
    temp = fhe.encode(x, 1, cryptoContext.L - c.cur_limb, global_num_slots, "release")  # Todo
    return fhe.homo_mult_pt(c, temp, cryptoContext)

def mask_mod_n2(c,n,cryptoContext):
    mask=[]
    for i in range(global_num_slots):
        if i%n==0:
            mask.append(1)
...
def wrapUpExpanded(vectors,cryptoContext):
    masked=mask_mod_n2(vectors[vectors[len(vectors)-1],128,cryptoContext])
...
def encoder1(cryptoContext,openfhe_context):
    ...
    query_b=read_plain_repeated_input(cryptoContext,"../weights-sst2/layer0_attself_query_bias.txt",0,1,global_num_slots)

    key_w=read_plain_input(cryptoContext,"../weights-sst2/layer0_attself_key_weight.txt",0,1,global_num_slots)
    key_b=read_plain_repeated_input(cryptoContext,"../weights-sst2/layer0_attself_key_bias.txt",0,1,global_num_slots)
    ...
    value_w=read_plain_input(cryptoContext,"../weights-sst2/layer0_attself_value_weight.txt",cryptoContext.L-scores.curlimb-2,1,global_num_slots)
    value_b=read_plain_repeated_input(cryptoContext,"../weights-sst2/layer0_attself_value_bias.txt",cryptoContext.L-scores.curlimb-1,1,global_num_slots)
    ...
    dense_w=read_plain_input(cryptoContext,"../weights-sst2/layer0_selfoutput_weight.txt",cryptoContext.L-output[0].curlimb,1,global_num_slots)
    dense_b=read_plain_expanded_input(cryptoContext,"../weights-sst2/layer0_selfoutput_bias.txt",cryptoContext.L-output[0].curlimb+1,1,global_num_slots)
    ...
    precomputed_mean=read_plain_repeated_input(cryptoContext,"../weights-sst2/layer0_selfoutput_mean.txt",cryptoContext.L-wrappedOutput.curlimb,-1,1,global_num_slots)
    wrappedOutput=fhe.homo_add_pt(wrappedOutput,precomputed_mean,cryptoContext)
    vy=read_plain_input(cryptoContext,"../weights-sst2/layer0_selfoutput_vy.txt",cryptoContext.L-wrappedOutput.curlimb,1,global_num_slots)
    wrappedOutput=fhe.homo_mul_pt(wrappedOutput,vy,cryptoContext)
    bias=read_plain_expanded_input(cryptoContext,"../weights-sst2/layer0_selfoutput_normbias.txt",cryptoContext.L-wrappedOutput.curlimb,1,global_num_slots,num_inputs=(inputs))
    ...
    intermediate_w_1=read_plain_input(cryptoContext,"../weights-sst2/layer0_intermediate_weight1.txt",cryptoContext.L-wrappedOutput.curlimb,GELU_max_abs_value,global_num_slots)
    intermediate_w_2=read_plain_input(cryptoContext,"../weights-sst2/layer0_intermediate_weight2.txt",cryptoContext.L-wrappedOutput.curlimb,GELU_max_abs_value,global_num_slots)
    intermediate_w_3=read_plain_input(cryptoContext,"../weights-sst2/layer0_intermediate_weight3.txt",cryptoContext.L-wrappedOutput.curlimb,GELU_max_abs_value,global_num_slots)
    intermediate_w_4=read_plain_input(cryptoContext,"../weights-sst2/layer0_intermediate_weight4.txt",cryptoContext.L-wrappedOutput.curlimb,GELU_max_abs_value,global_num_slots)
    dense_weights=list[intermediate_w_1, intermediate_w_2, intermediate_w_3, intermediate_w_4]
    intermediate_bias=read_plain_input(cryptoContext,"../weights-sst2/layer0_intermediate_bias.txt",cryptoContext.L-output[0].curlimb+1,GELU_max_abs_value,global_num_slots)
    ...
    output_w_1=read_plain_input(cryptoContext,"../weights-sst2/layer0_output_weight1.txt",cryptoContext.L-unwrappedLargeOutput[0][0].curlimb,1,global_num_slots)
    output_w_2=read_plain_input(cryptoContext,"../weights-sst2/layer0_output_weight2.txt",cryptoContext.L-unwrappedLargeOutput[0][0].curlimb,1,global_num_slots)
    output_w_3=read_plain_input(cryptoContext,"../weights-sst2/layer0_output_weight3.txt",cryptoContext.L-unwrappedLargeOutput[0][0].curlimb,1,global_num_slots)
    output_w_4=read_plain_input(cryptoContext,"../weights-sst2/layer0_output_weight4.txt",cryptoContext.L-unwrappedLargeOutput[0][0].curlimb,1,global_num_slots)
    output_bias=read_plain_expanded_input(cryptoContext,"../weights-sst2/layer0_output_bias.txt",cryptoContext.L-unwrappedLargeOutput[0][0].curlimb+1,1,global_num_slots)
    ...
    precomputed_mean=read_plain_repeated_input(cryptoContext,"../weights-sst2/layer0_output_mean.txt",cryptoContext.L-wrappedOutput.curlimb,-1,global_num_slots)
    wrappedOutput=fhe.homo_add_pt(wrappedOutput,precomputed_mean,cryptoContext)
    vy=read_plain_input(cryptoContext,"../weights-sst2/layer0_output_vy.txt",cryptoContext.L-wrappedOutput.curlimb,1,global_num_slots)
    wrappedOutput=fhe.homo_add_pt(wrappedOutput,vy,cryptoContext)
    bias=read_plain_expanded_input(cryptoContext,"../weights-sst2/layer0_output_normbias.txt",cryptoContext.L-wrappedOutput.curlimb,1,global_num_slots,len(inputs))
    wrappedOutput=fhe.homo_add_pt(wrappedOutput,bias,cryptoContext)
    output=unwrapExpanded(wrappedOutput,len(inputs),cryptoContext)
...
def encoder2(inputs,cryptoContext):
    query_w = read_plain_input(cryptoContext,"../weights-sst2/layer1_attself_query_weight.txt",cryptoContext.L-inputs[0].curlimb,1,global_num_slots)
    query_b = read_plain_repeated_input(cryptoContext,"../weights-sst2/layer1_attself_query_bias.txt",cryptoContext.L-inputs[0].curlimb,1,global_num_slots)
    key_w = read_plain_input(cryptoContext,"../weights-sst2/layer1_attself_key_weight.txt",cryptoContext.L-inputs[0].curlimb,1,global_num_slots)
    key_b = read_plain_repeated_input(cryptoContext,"../weights-sst2/layer1_attself_key_bias.txt",cryptoContext.L-inputs[0].curlimb,1,global_num_slots)
    Q = matmulRE1(inputs, query_w, query_b, cryptoContext)
    K = matmulRE1(inputs, key_w, key_b, cryptoContext)
    K_wrapped = wrapUpRepeated(K, cryptoContext)
    scores = matmulScores(Q, K_wrapped, cryptoContext)
    ...
    value_w = read_plain_input(cryptoContext,"../weights-sst2/layer1_attself_value_weight.txt", cryptoContext.L -inputs[0].curlimb,1,global_num_slots)
    value_b = read_plain_repeated_input(cryptoContext,"../weights-sst2/layer1_attself_value_bias.txt",
                                        cryptoContext.L - inputs[0].curlimb,1,global_num_slots )
    V = matmulRE1(inputs, value_w, value_b, cryptoContext)
    V_wrapped = wrapUpRepeated(V, cryptoContext)
    output = matmulRE2(unwrapped_scores, V_wrapped, 128, 128, cryptoContext)
    ...
    dense_w = read_plain_input(cryptoContext,"../weights-sst2/layer1_selfoutput_weight.txt", cryptoContext.L - output[0].curlimb,1,global_num_slots)
    dense_b = read_plain_expanded_input(cryptoContext,"../weights-sst2/layer1_selfoutput_bias.txt",
                                        cryptoContext.L - output[0].curlimb + 1,1,global_num_slots)
    output = matmulCR2(output, dense_w, dense_b, cryptoContext)
    for i in range(len(output)):
        output[i] = fhe.homo_add(output[i], inputs[i], cryptoContext)
    wrappedOutput = wrapUpExpanded(output, cryptoContext)
    ...
    wrappedOutput = fhe.homo_add_pt(wrappedOutput, precomputed_mean, cryptoContext)
    vy = read_plain_input(cryptoContext,"../weights-sst2/layer1_selfoutput_vy.txt", cryptoContext.L - wrappedOutput.curlimb,1,global_num_slots)
    wrappedOutput = fhe.homo_mul_pt(wrappedOutput, vy, cryptoContext)
    bias = read_plain_expanded_input(cryptoContext,"../weights-sst2/layer1_selfoutput_normbias.txt",
                                     cryptoContext.L - wrappedOutput.curlimb, 1, global_num_slots,len(inputs))
    wrappedOutput = fhe.homo_add_pt(wrappedOutput, bias, cryptoContext)
    ...
    intermediate_w_1 = read_plain_input(cryptoContext,"../weights-sst2/layer1_intermediate_weight1.txt",
                                        cryptoContext.L - wrappedOutput.curlimb, GELU_max_abs_value,global_num_slots)
    intermediate_w_2 = read_plain_input(cryptoContext,"../weights-sst2/layer1_intermediate_weight2.txt",
                                        cryptoContext.L - wrappedOutput.curlimb, GELU_max_abs_value,global_num_slots)
    intermediate_w_3 = read_plain_input(cryptoContext,"../weights-sst2/layer1_intermediate_weight3.txt",
                                        cryptoContext.L - wrappedOutput.curlimb, GELU_max_abs_value,global_num_slots)
    ...
    intermediate_bias = read_plain_input(cryptoContext,"../weights-sst2/layer1_intermediate_bias.txt",
                                         cryptoContext.L - output[0].curlimb + 1, GELU_max_abs_value,global_num_slots)
    output = matmulRElarge(output, dense_weights, intermediate_bias, cryptoContext)
    output = generate_containers(output, None, cryptoContext)
    for i in range(len(output)):
    ...
    output_w_1 = read_plain_input(cryptoContext,"../weights-sst2/layer1_output_weight1.txt",
                                  cryptoContext.L - output[0].curlimb,1,global_num_slots)
    output_w_2 = read_plain_input(cryptoContext,"../weights-sst2/layer1_output_weight2.txt",
                                  cryptoContext.L - output[0].curlimb,1,global_num_slots)
    output_w_3 = read_plain_input(cryptoContext,"../weights-sst2/layer1_output_weight3.txt",
                                  cryptoContext.L - output[0].curlimb,1,global_num_slots)
    ...
    output_bias = read_plain_expanded_input(cryptoContext,"../weights-sst2/layer1_output_bias.txt",
                                            cryptoContext.L - output[0].curlimb.curlimb + 1,1,global_num_slots)
    ...
    precomputed_mean = read_plain_repeated_input(cryptoContext,"../weights-sst2/layer1_output_mean.txt",
                                                 cryptoContext.L - wrappedOutput.curlimb, -1,1,global_num_slots)
    wrappedOutput = fhe.homo_add_pt(wrappedOutput, precomputed_mean, cryptoContext)
    vy = read_plain_input(cryptoContext,"../weights-sst2/layer1_output_vy.txt", cryptoContext.L - wrappedOutput.curlimb, 1,global_num_slots)
    wrappedOutput = fhe.homo_add_pt(wrappedOutput, vy, cryptoContext)
...
def classifier(input,cryptoContext,openfhe_context):
    weight=read_plain_input(cryptoContext,"../weights-sst2/classifier_weight.txt",cryptoContext.L - input.curlimb,1,global_num_slots)
    bias=read_plain_expanded_input(cryptoContext,"../weights-sst2/classifier_bias.txt",cryptoContext.L - input.curlimb,1,global_num_slots)
...
def pooler(input,cryptoContext,openfhe_context):
    tanhScale=1/30.0
    weight = read_plain_input(cryptoContext,"../weights-sst2/pooler_dense_weight.txt", cryptoContext.L - input.curlimb,tanhScale,global_num_slots)
    bias = read_plain_expanded_input(cryptoContext,"../weights-sst2/pooler_dense_bias.txt", cryptoContext.L - input.curlimb,tanhScale,global_num_slots)
