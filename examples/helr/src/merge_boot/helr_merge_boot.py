...
class SecureML:
    ...
    def sigmoid(self, cryptoContext, enc_grad, enc_z_data, enc_ip, gamma):
        ...
        enc_ip_sqr = fhe.homo_add_scalar_double(enc_ip_sqr, self.params.degree3[1] / self.params.degree3[3],
                                                cryptoContext)
...
def test(cryptoContext, openfhe_context, encode_slots, logBsSlots_list, levelBudget_list, file, file_test, is_first,
    ...
    secure_ml.test_auroc(secure_ml, secure_ml.z_data_test, secure_ml.factor_num_test, secure_ml.sample_num_test,
                         dw_data, secure_ml.params.is_first)
