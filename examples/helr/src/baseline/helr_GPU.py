...
class SecureML:
    ...
    @fhe.utils.profile_python_function
    def training(self, cryptoContext, enc_w_data, enc_v_data, factor_num, sample_num, w_data, z_data, block_array, openfhe_context, logBsSlots_list, levelBudget_list, print_all=False):
