...
from easyfhe.utils._content_store import ContentStoreReader
...
def register_debug_prims() -> None:
    ...
    def load_tensor_factory(
        ...
        if LOAD_TENSOR_READER is None:
            from easyfhe._dynamo.testing import rand_strided

            return rand_strided(size, stride, dtype, device)
        else:
            from easyfhe._dynamo.utils import clone_input
