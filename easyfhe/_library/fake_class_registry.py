...
from easyfhe._library.utils import parse_namespace
from easyfhe.utils._python_dispatch import _disable_current_modes
...
class FakeScriptObject:
    def __init__(
        ...
        from easyfhe._library.opaque_object import is_opaque_type
...
class FakeScriptMethod:
    ...
    def __call__(self, *args, **kwargs):
        from easyfhe._higher_order_ops.torchbind import call_torchbind
...
def maybe_to_fake_obj(
    ...
    from easyfhe._library.opaque_object import (
        FakeOpaqueObject,
        get_opaque_obj_info,
    ...
    if is_opaque_type(x_type):
        ...
        with fake_mode:
            from easyfhe._higher_order_ops.utils import _tensor_storage
