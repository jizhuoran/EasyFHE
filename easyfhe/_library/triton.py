...
from easyfhe.utils._exposed_in import exposed_in
...
def get_inner_triton_kernels(fn: Callable[..., Any]) -> list[object]:
    ...
    def find_triton_kernels(
        ...
        from easyfhe._inductor.utils import IndentedBuffer
        ...
        for func_name in collector.called_functions:
            ...
            if func_obj is None:
                from easyfhe._library.custom_ops import OPDEFS
    ...
    *,
    ...
    def dec(fn: Callable[..., object]) -> CustomOpDef:
        ...
        def functional_decomp(  # type: ignore[no-untyped-def]
            ...
            from easyfhe.export._trace import custom_triton_ops_decomposition_disabled
...
def wrap_triton(triton_kernel: Callable, /) -> Any:
    ...
    from easyfhe._higher_order_ops.triton_kernel_wrap import TraceableTritonKernelWrapper
