...
import torchgen
from easyfhe import _C, _utils_internal
...
def get_layout_constraint_tag(fn, *, with_default=True):
    ...
    if with_default:
        ...
        import easyfhe as torch
        import easyfhe._functorch
        from easyfhe._functorch import config
...
def is_impure(
    ...
    *,
    ...
    from easyfhe._higher_order_ops.effects import _get_effect
