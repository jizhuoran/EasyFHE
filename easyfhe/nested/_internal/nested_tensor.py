...
from easyfhe._C import DispatchKey, DispatchKeySet
from easyfhe._prims_common import is_expandable_to
...
def get_tensor_symint(tensor, *, coeff=1):
    ...
    from easyfhe._subclasses.functional_tensor import mb_unwrap_functional_tensor
...
class NestedTensor(torch.Tensor):
    ...
    def _is_contiguous_or_false(self):
        if self.lengths() is not None:
            return False
        from easyfhe._prims_common import is_contiguous_for_memory_format_or_false
    ...
    def __torch_function__(cls, func, types, args=(), kwargs=None):
        ...
        from easyfhe.fx.experimental.proxy_tensor import maybe_enable_thunkify
