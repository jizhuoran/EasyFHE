...
from easyfhe import SymInt, Tensor
from easyfhe._C import _add_docstr, _nested  # type: ignore[attr-defined]
from easyfhe.types import _device as Device, _dtype as DType
...
def as_nested_tensor(
    ...
    if layout == torch.strided:
        ...
        if isinstance(ts, Tensor):
            ...
            from easyfhe.nested._internal.nested_tensor import (
            ...
            from easyfhe.nested._internal.nested_tensor import jagged_from_list
...
def narrow(
    ...
    if layout == torch.strided:
        ...
        from easyfhe.nested._internal.nested_tensor import jagged_from_tensor_and_lengths
...
def nested_tensor_from_jagged(
    ...
    Example::
        ...
        True
    """
    from easyfhe.fx._symbolic_trace import is_fx_tracing
...
def masked_select(tensor: Tensor, mask: Tensor) -> Tensor:
    ...
    from easyfhe.nested._internal.nested_tensor import nested_view_from_values_offsets
