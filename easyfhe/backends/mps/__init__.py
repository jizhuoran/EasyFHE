...
from easyfhe.library import Library as _Library
...
def _init() -> None:
    ...
    from easyfhe._decomp.decompositions import native_group_norm_backward
    from easyfhe._refs import native_group_norm
