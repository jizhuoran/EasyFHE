...
Example usage::
    ...
    import easyfhe.backends.python_native as pn
...
from easyfhe.backends import ContextProp, flags_frozen, PropModule
...
def _get_dsl_registry():
    ...
    from easyfhe._native.dsl_registry import dsl_registry
...
def _get_registry_functions():
    ...
    from easyfhe._native.registry import (
        _filter_state,
        _graphs,
...
class PythonNativeModule(PropModule):
    ...
    def get_dsl_operations(self, dsl_name: str) -> list[str]:
        ...
        """
        from easyfhe._native.registry import get_dsl_operations
