...
import easyfhe._prims_common as utils
from easyfhe import SymBool, SymFloat, Tensor
from easyfhe._decomp import (
    _add_op_to_registry,
    _convert_out_params,
...
from easyfhe._prims import _prim_elementwise_meta, ELEMENTWISE_PRIM_TYPE_PROMOTION_KIND
from easyfhe._prims_common import (
    BoolLike,
...
from easyfhe._prims_common.wrappers import (
...
from easyfhe._refs import _broadcast_shapes, _maybe_broadcast
from easyfhe.fx.experimental import _config as exp_config
from easyfhe.nn.functional import ScalingType, SwizzleType
from easyfhe.utils import _pytree as pytree
...
def meta_copy_(self, src, non_blocking=False):
    ...
    from easyfhe.fx.experimental.symbolic_shapes import free_unbacked_symbols
...
def sym_constrain_range(size, min=None, max=None):
    ...
    from easyfhe.fx.experimental.symbolic_shapes import constrain_range
...
def sym_constrain_range_for_size(size, min=None, max=None):
    # Avoid importing sympy at a module level
    from easyfhe.fx.experimental.symbolic_shapes import _constrain_range_for_size
...
def meta_baddbmm(self, batch1, batch2, *, beta=1, alpha=1):
    from easyfhe.fx.experimental.symbolic_shapes import guard_or_true, sym_eq
...
def calc_conv_nd_return_shape(
    ...
    from easyfhe._subclasses.fake_tensor import FakeTensor
    from easyfhe.fx.experimental.symbolic_shapes import sym_or
...
def meta_conv(
    ...
    from easyfhe.fx.experimental.symbolic_shapes import guard_or_false
...
def meta_index_Tensor(self, indices):
    ...
    # expand_outplace
    import easyfhe._refs as refs  # avoid import cycle in mypy
...
def common_meta_baddbmm_bmm(batch1, batch2, is_bmm, self_baddbmm=None, out_dtype=None):
    from easyfhe.fx.experimental.symbolic_shapes import sym_and, sym_eq
...
def scatter_gather_dtype_check(method_name, self, index, src_opt=None):
    from easyfhe.fx.experimental.symbolic_shapes import guard_or_true
...
def kthvalue_meta(self, k, dim=-1, keepdim=False):
    from easyfhe.fx.experimental.symbolic_shapes import sym_and
...
# decompositions
import easyfhe as torch
import easyfhe._refs
import easyfhe as torch
import easyfhe._refs.nn.functional
import easyfhe as torch
import easyfhe._refs.special
