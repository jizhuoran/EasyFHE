...
if TYPE_CHECKING:
    ...
    from easyfhe.cuda import _POOL_HANDLE
...
from easyfhe._C import _cuda_isCurrentStreamCapturing, _CUDAGraph, _graph_pool_handle
...
class graph:
    ...
    def __enter__(self) -> None:
        ...
        if self._enable_annotations:
            from easyfhe.cuda._graph_annotations import enable_annotations as _enable_ann
    ...
    def __exit__(self, *args: object) -> None:
        if self._enable_annotations:
            from easyfhe.cuda._graph_annotations import resolve_pending_annotations
        ...
        if self._enable_annotations:
            from easyfhe.cuda._graph_annotations import remap_to_exec_graph
