...
from easyfhe._utils import _get_device_index as _torch_get_device_index
...
def _get_gpu_rtc_compatible_flags() -> list[str]:
    ...
    """
    from easyfhe.utils.cpp_extension import COMMON_HIPCC_FLAGS, COMMON_NVCC_FLAGS
...
def _nvrtc_compile(
    ...
    from easyfhe.utils.cpp_extension import include_paths
...
class _CudaModule:
    ...
    def __getattr__(self, name: str) -> "_CudaKernel":
        ...
        from easyfhe.cuda._utils import _get_gpu_runtime_library
