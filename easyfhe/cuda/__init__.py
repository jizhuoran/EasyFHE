...
import easyfhe as torch
import easyfhe._C
from easyfhe._utils import _dummy_type, _LazySeedTracker, classproperty
from easyfhe.types import Device
...
try:
    from easyfhe._C import _cudart  # type: ignore[attr-defined]
except ImportError:
    _cudart = None
...
_AMDSMI_ERR = None
try:
    from easyfhe import version as _version
...
from easyfhe.storage import _LegacyStorage, _warn_typed_storage_removal
...
def _register_triton_kernels():
    ...
    def kernel_impl(*args, **kwargs):
        from easyfhe.sparse._triton_ops import bsr_dense_mm
    ...
    def addmm_kernel_impl(*args, **kwargs):
        from easyfhe.sparse._triton_ops import bsr_dense_addmm
...
def _compile_kernel(
    ...
    """
    from easyfhe.cuda._utils import _cuda_load_module, _nvrtc_compile
