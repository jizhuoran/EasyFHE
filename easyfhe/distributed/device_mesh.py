...
from easyfhe.distributed import is_available
from easyfhe.distributed._mesh_layout import _FlatLayout, _MeshLayout
from easyfhe.types import IntLikeType
from easyfhe.utils._typing_utils import not_none
...
if not is_available():
    ...
    from easyfhe._C._distributed_c10d import Backend as C10dBackend
    from easyfhe.distributed import config as dist_config
    from easyfhe.distributed.distributed_c10d import (
        _get_default_group,
    ...
    class DeviceMesh(OpaqueBase):
        ...
        def __getitem__(self, mesh_dim_names: str | tuple[str, ...]) -> "DeviceMesh":
            ...
            if mesh_dim_names == self._mesh_dim_names:
                ...
                from easyfhe.fx.experimental.proxy_tensor import (
        ...
        def _sym_get_coordinate(self, index: int) -> IntLikeType:
            import easyfhe.distributed.config as config
...
def _device_mesh_reconstruct_fn(
    ...
    from easyfhe.distributed._ops import device_mesh as _dm_ops  # noqa: F401
...
def _register_distributed_opaque_types():
    ...
    from easyfhe._library.opaque_object import MemberType, register_opaque_type
