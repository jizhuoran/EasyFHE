...
import easyfhe.distributed._functional_collectives as funcol
import easyfhe.distributed.distributed_c10d as c10d
from easyfhe._C._autograd import DeviceType
from easyfhe._C._distributed_c10d import _SymmetricMemory, Work as _Work
...
if TYPE_CHECKING:
    from easyfhe._C._distributed_c10d import ProcessGroup
    from easyfhe.types import _device, _dtype, _int
...
def is_nvshmem_available() -> bool:
    ...
    """
    try:
        from easyfhe._C._distributed_c10d import _is_nvshmem_available
    except ImportError:
