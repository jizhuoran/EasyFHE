...
from easyfhe.distributed._symmetric_memory._shmem_triton_utils import (
    run_shmem_init_hook,
    ShmemKernelRegistry,
)
from easyfhe.utils._triton import has_triton
...
def _rocshmem_init_hook(*args, **kwargs) -> None:  # type: ignore[no-untyped-def]
    ...
    """
    from easyfhe._C._distributed_c10d import _nvshmemx_cumodule_init
