...
from easyfhe.nn.utils.rnn import PackedSequence
    ...
    def to_map(obj):
        if isinstance(obj, (torch.Tensor, PackedSequence)):
            ...
            if not use_side_stream_for_tensor_copies:
                ...
                from easyfhe.nn.parallel._functions import _get_stream
        ...
        from easyfhe.nn.parallel.scatter_gather import _is_namedtuple
