...
import easyfhe._numpy as np
from easyfhe._numpy import arange, asarray as asanyarray, empty, float32, intp, ndarray
...
def assert_equal(actual, desired, err_msg="", verbose=True):
    ...
    from easyfhe._numpy import imag, iscomplexobj, isscalar, ndarray, real, signbit
...
def assert_almost_equal(actual, desired, decimal=7, err_msg="", verbose=True):
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from easyfhe._numpy import imag, iscomplexobj, ndarray, real
...
def assert_array_compare(
    ...
    *,
    ...
    __tracebackhide__ = True  # Hide traceback for py.test
    from easyfhe._numpy import all, array, asarray, bool_, inf, isnan, max
...
def assert_array_almost_equal(x, y, decimal=6, err_msg="", verbose=True):
    ...
    """
    __tracebackhide__ = True  # Hide traceback for py.test
    from easyfhe._numpy import any as npany, float_, issubdtype, number, result_type
