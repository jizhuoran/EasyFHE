...
from easyfhe._prims_common import corresponding_real_dtype
from easyfhe.masked import _docs
from easyfhe.masked.maskedtensor.core import is_masked_tensor, MaskedTensor
from easyfhe.masked.maskedtensor.creation import as_masked_tensor


if TYPE_CHECKING:
    from easyfhe._prims_common import DimsType
    from easyfhe.types import _dtype as DType
