...
from easyfhe import _utils_internal
from easyfhe._C import _dispatch_is_included_in_alias as is_included_in_alias, DispatchKey
try:
    from easyfhe._functorch.pyfunctorch import dispatch_functorch, TransformType
...
if TYPE_CHECKING:
    from easyfhe._subclasses.functional_tensor import BaseFunctionalizeAPI
...
class OperatorBase:
    ...
    def py_functionalize_impl(
        ...
        from easyfhe._subclasses.functional_tensor import (
            CppFunctionalizeAPI,
            FunctionalTensorMode,
        ...
        def functionalize_dispatch_mode_fn(
            ...
            from easyfhe._higher_order_ops.utils import has_user_subclass
            from easyfhe._subclasses import FakeTensor
...
class HigherOrderOperator(OperatorBase, abc.ABC):
    ...
    def py_autograd_impl(
        ...
        def maybe_run_autograd(*args: _P.args, **kwargs: _P.kwargs) -> _T:
            ...
            from easyfhe._higher_order_ops.utils import _has_gen_schema
    ...
    def cacheable(self) -> bool:
        from easyfhe._functorch.autograd_function import AutogradFunctionApply
    ...
    def dispatch(self, /, dispatch_key, *args, **kwargs):
        from easyfhe.utils._python_dispatch import _get_current_dispatch_mode
        ...
        if dispatch_key == DispatchKey.Python:
            ...
            from easyfhe.utils._python_dispatch import _pop_mode_temporarily
...
def _set_mode_pre_dispatch(mode):
    from easyfhe._subclasses.functional_tensor import FunctionalTensorMode
    from easyfhe._subclasses.schema_check_mode import SchemaCheckMode
    from easyfhe.fx.experimental.proxy_tensor import ProxyTorchDispatchMode
...
class OpOverload(OperatorBase, Generic[_P, _T]):
    ...
    def _get_dispatch(self, key: DispatchKey) -> DispatchKey | Callable[_P, _T]:
        ...
        if key == DispatchKey.Functionalize:
            import easyfhe._dispatch.python as pydispatch
