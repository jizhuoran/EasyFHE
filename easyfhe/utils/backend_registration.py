...
from easyfhe._C import _get_privateuse1_backend_name, _rename_privateuse1_backend
from easyfhe.overrides import handle_torch_function, has_torch_function_unary
...
def _rename_profiler_activity(backend_name: str) -> None:
    ...
    from easyfhe._C._profiler import ProfilerActivity
