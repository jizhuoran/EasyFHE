...
from easyfhe._logging import warning_once
from easyfhe._subclasses.fake_tensor import FakeTensor, FakeTensorMode

# Import _utils module for mutable globals
from easyfhe.utils._debug_mode import _utils
from easyfhe.utils._debug_mode._calls import (
    _AnnotateCall,
    _get_call_name,
    _OpCall,
...
from easyfhe.utils._debug_mode._utils import (
    _compute_rel_diff,
...
from easyfhe.utils._pytree import (
    keystr,
    tree_all,
    tree_map,
    tree_map_only,
...
if TYPE_CHECKING:
    from easyfhe.distributed._tools.mod_tracker import ModTracker
...
class DebugMode(TorchDispatchMode):
    def __init__(
        ...
        *,
        ...
        super().__init__()
        import easyfhe as torch
        import easyfhe.distributed.tensor  # noqa: F401
    ...
    def __torch_dispatch__(self, func, types, args=(), kwargs=None):
        ...
        from easyfhe.distributed._functional_collectives import AsyncCollectiveTensor
        from easyfhe.distributed._local_tensor import LocalTensor
    ...
    def record_output_placements(self, output_spec) -> None:
        ...
        if not self.record_output:
            return
        from easyfhe.distributed.tensor._dtensor_spec import DTensorSpec
