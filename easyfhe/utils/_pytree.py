...
from easyfhe.torch_version import TorchVersion as _TorchVersion
...
if TYPE_CHECKING:
    import easyfhe.utils._cxx_pytree as cxx_pytree
...
def _is_pytreespec_instance(
    ...
    if "torch._dynamo.polyfills.pytree" in sys.modules:
        ...
        import easyfhe._dynamo.polyfills.pytree as dynamo_pytree
