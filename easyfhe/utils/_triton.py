...
def has_triton() -> bool:
    ...
    from easyfhe._inductor.config import triton_disable_device_detection

    if triton_disable_device_detection:
        return False

    from easyfhe._dynamo.device_interface import get_interface_for_device
...
def triton_hash_with_backend() -> str:
    from easyfhe._inductor.runtime.triton_compat import triton_key
