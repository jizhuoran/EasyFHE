...
if _TYPE_CHECKING:
    from easyfhe.serialization import LoadEndianness as _LoadEndianess

from easyfhe.utils._config_module import install_config_module as _install_config_module
