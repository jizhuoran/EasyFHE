...
import easyfhe._weights_only_unpickler as _weights_only_unpickler
from easyfhe._sources import get_source_lines_and_file
from easyfhe._utils import _import_dotted_name
from easyfhe.storage import _get_dtype_from_pickle_storage_type
from easyfhe.types import FileLike, Storage
...
def get_default_load_endianness() -> LoadEndianness | None:
    ...
    """
    from easyfhe.utils.serialization import config
