...
def _chunk_or_narrow_cat(
    ...
    if torch.distributed.is_available():
        from easyfhe.distributed._functional_collectives import _are_we_tracing
...
def _augment_frames(frames: list[_Frame]) -> int:
    ...
    """
    from easyfhe.fx.graph_module import FX_GRAPH_MODULE_FILE_PREFIX
    from easyfhe.fx.traceback import _FX_METADATA_REGISTRY
