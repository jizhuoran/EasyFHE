...
from easyfhe.jit._serialization import validate_map_location
...
def _get_model_bytecode_version(f_input) -> int:
    ...
    .. testcode::
        ...
        from easyfhe.jit.mobile import _get_model_bytecode_version
...
def _get_mobile_model_contained_types(f_input) -> int:
    ...
    .. testcode::
        ...
        from easyfhe.jit.mobile import _get_mobile_model_contained_types
...
def _get_model_ops_and_info(f_input):
    ...
    .. testcode::
        ...
        from easyfhe.jit.mobile import _get_model_ops_and_info
