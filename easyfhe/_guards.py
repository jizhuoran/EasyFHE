...
from easyfhe.utils._ordered_set import OrderedSet
from easyfhe.utils._python_dispatch import is_traceable_wrapper_subclass
from easyfhe.utils._traceback import CapturedTraceback, format_frame
from easyfhe.utils.weak import WeakTensorKeyDictionary
...
if TYPE_CHECKING:
    ...
    from easyfhe._dynamo.backends.distributed import DDPOptimizerContext
    from easyfhe._dynamo.codegen import PyCodegen
    from easyfhe._dynamo.guards import GuardCheckSpec
    from easyfhe._functorch._aot_autograd.schemas import ViewAndMutationMeta
    from easyfhe._higher_order_ops.invoke_subgraph import NestedCompileRegionOptions
...
class HopDispatchSetCache:
    def __init__(self) -> None:
        ...
        from easyfhe._higher_order_ops.invoke_subgraph import invoke_subgraph
...
def detect_fake_mode(inputs: Any = None) -> FakeTensorMode | None:
    ...
    from easyfhe.utils._python_dispatch import _get_current_dispatch_mode_stack
