...
from easyfhe._utils import _to, _type
from easyfhe.types import _bool, _int, Storage


if TYPE_CHECKING:
    from easyfhe._prims_common import DeviceLikeType
...
class _StorageBase:
    ...
    def share_memory_(self):
        ...
        from easyfhe.multiprocessing import get_sharing_strategy
...
class TypedStorage:
    ...
    def _getitem(self, idx):
        ...
        from easyfhe._subclasses.fake_tensor import unset_fake_temporarily
