...
if TYPE_CHECKING:
    from easyfhe.export.decomp_utils import CustomDecompTable

import easyfhe as torch
import easyfhe as torch
import easyfhe.library
from easyfhe._ops import HigherOrderOperator, OperatorBase, OpOverload, OpOverloadPacket
from easyfhe._prims_common import CustomOutParamAnnotation
...
# populate the table
import easyfhe as torch
import easyfhe._decomp.decompositions
import easyfhe as torch
import easyfhe._refs


def core_aten_decompositions() -> "CustomDecompTable":
    from easyfhe.export.exported_program import default_decompositions
