...
import easyfhe as torch
import easyfhe._custom_op
import easyfhe as torch
import easyfhe._logging
import easyfhe._prims_common as utils
from easyfhe._dispatch.python import no_python_dispatcher
...
from easyfhe.fx.operator_schemas import _normalize_function_or_error
from easyfhe.utils._stats import count_label
...
def _view_has_unbacked_input(
    ...
    from easyfhe.fx.experimental.symbolic_shapes import has_guarding_hint
...
def _view_unbacked_meta(
    ...
    from easyfhe._prims import view_of
    from easyfhe.fx.experimental.symbolic_shapes import guard_or_false, sym_eq
...
def nonzero(fake_mode: FakeTensorMode, func: OpOverload, arg: FakeTensor) -> FakeTensor:
    ...
    if (nnz := arg.nonzero_memo) is None:
        ...
        from easyfhe.utils._sympy.numbers import IntInfinity
        from easyfhe.utils._sympy.value_ranges import bound_sympy
...
def _compute_slice_index(size: IntLikeType, index: IntLikeType) -> IntLikeType | None:
    from easyfhe.fx.experimental.symbolic_shapes import guard_or_false, sym_and
...
def index_tensor(
    ...
    from easyfhe._meta_registrations import meta_index_Tensor
...
def embedding_bag(
    ...
    from easyfhe._meta_registrations import meta_embedding_bag
