...
from easyfhe._C._autograd import CreationMeta
from easyfhe._C._functorch import (
    _add_batch_dim,
...
from easyfhe._dispatch.python import enable_python_dispatcher
from easyfhe._logging import trace_structured
from easyfhe._opaque_base import OpaqueBase
from easyfhe.utils._mode_utils import no_dispatch
from easyfhe.utils._python_dispatch import is_traceable_wrapper_subclass
from easyfhe.utils.weak import WeakIdKeyDictionary


if TYPE_CHECKING:
    from collections.abc import Callable, Generator

    from easyfhe._C._functorch import CInterpreter
    ...
    from easyfhe.types import IntLikeType
...
class MetaTensorDescriber:
    ...
    def describe_tensor(
        ...
        if is_traceable_wrapper_subclass_v:
            ...
            for attr in raw_attrs:
                ...
                match inner:
                    ...
                    case OpaqueBase():
                        from easyfhe._library.fake_class_registry import (
        ...
        from easyfhe.nested._internal.nested_tensor import _tensor_symint_registry
...
class MetaConverter(Generic[_TensorT]):
    ...
    def _empty_create_subclass(
        ...
        from easyfhe._dynamo.source import AttrSource
        from easyfhe.fx.experimental.symbolic_shapes import SubclassSymbolicContext
    ...
    def meta_tensor(
        ...
        if source is None:
            from easyfhe._dynamo.source import ConstantSource
        ...
        def sym_sizes_strides_storage_offset(
            ...
            from easyfhe.fx.experimental.symbolic_shapes import is_symbolic
        ...
        def view_from_base(
            ...
            with enable_python_dispatcher():
                ...
                from easyfhe._dynamo.source import EphemeralSource
                from easyfhe.fx.experimental.symbolic_shapes import (
                    StatelessSymbolicContext,
                    sym_eq,
                )
        ...
        if self.get_tensor_memo(t) is None:
            ...
            with torch.inference_mode(t.is_inference):
                if t.is_sparse:
                    ...
                    from easyfhe._dynamo.exc import unimplemented
