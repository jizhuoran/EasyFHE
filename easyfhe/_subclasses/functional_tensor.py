...
if TYPE_CHECKING:
    ...
    from easyfhe._functorch.pyfunctorch import FunctionalizeInterpreter
    from easyfhe._ops import OpOverload

import easyfhe as torch
import easyfhe.fx.traceback as fx_traceback
import easyfhe.utils._pytree as pytree
from easyfhe._C import _functionalization_reapply_views_tls as _reapply_views
from easyfhe._ops import _get_dispatch_mode_pre_dispatch, TorchBindOpOverload
from easyfhe._subclasses.meta_utils import is_sparse_any
...
def _can_decompose_fast(
    ...
    from easyfhe._decomp import _should_decompose_because_unsafe_op
...
class FunctionalTensorMode(TorchDispatchMode):
    ...
    def __torch_dispatch__(
        ...
        if can_auto_functionalize(
            ...
            import easyfhe._export.config as export_config
        ...
        from easyfhe._higher_order_ops.effects import handle_effects, has_effects
...
class CppFunctionalizeAPI(BaseFunctionalizeAPI):
    def wrap_tensors(self, args: tuple[Any, ...]) -> tuple[Any, ...]:
        from easyfhe._functorch.eager_transforms import _wrap_all_tensors_to_functional
    ...
    def unwrap_tensors(
        ...
        from easyfhe._functorch.eager_transforms import (
