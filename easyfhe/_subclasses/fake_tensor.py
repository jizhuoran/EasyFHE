...
import easyfhe._library.utils as library_utils
from easyfhe import SymBool, SymFloat, SymInt, Tensor
from easyfhe._C._functorch import is_functorch_wrapped_tensor, is_legacy_batchedtensor
from easyfhe._library.fake_class_registry import FakeScriptObject
from easyfhe._library.fake_profile import MissingOpProfile
from easyfhe._logging import dtrace_structured
from easyfhe._opaque_base import OpaqueBase
from easyfhe._prims_common import suggest_memory_format
from easyfhe._subclasses.meta_utils import (
    assert_eq,
    assert_metadata_eq,
    is_sparse_any,
...
from easyfhe._utils import _is_privateuse1_backend_available, render_call
from easyfhe.fx.immutable_collections import immutable_dict
from easyfhe.fx.operator_schemas import normalize_function
from easyfhe.multiprocessing.reductions import StorageWeakRef
from easyfhe.overrides import TorchFunctionMode
from easyfhe.types import IntLikeType, py_sym_types
from easyfhe.utils._mode_utils import no_dispatch
from easyfhe.utils._python_dispatch import (
    is_traceable_wrapper_subclass,
    TorchDispatchMode,
    TraceableWrapperSubclass,
)
from easyfhe.utils._pytree import KeyPath, keystr, PyTree, tree_map, tree_map_, TreeSpec
from easyfhe.utils._stats import count
from easyfhe.utils._traceback import CapturedTraceback
...
if TYPE_CHECKING:
    ...
    from easyfhe._guards import Source
    from easyfhe._ops import OpOverload
    from easyfhe.fx.experimental.symbolic_shapes import ShapeEnv, SymbolicContext
...
def is_fake(x: object) -> TypeGuard[Tensor]:
    from easyfhe._subclasses.functional_tensor import FunctionalTensor
...
def torch_decomp_decompositions(func: OpOverload) -> bool:
    from easyfhe._decomp import decomposition_table
...
class FakeTensorConverter:
    ...
    def from_real_tensor(
        ...
        *,
        ...
        if not symbolic_context and not source and shape_env:
            if tracing_context := torch._guards.TracingContext.try_get():
                if t in tracing_context.tensor_to_context:
                    ...
                    from easyfhe.fx.experimental.symbolic_shapes import (
        ...
        from easyfhe._dynamo.source import RandomValueSource
        ...
        if (
            ...
            from easyfhe._dynamo.source import CallMethodItemSource, FloatTensorSource
            from easyfhe.fx.experimental.symbolic_shapes import DimDynamic
...
class FakeTensorMode(TorchDispatchMode):
    ...
    def __init__(
        ...
        *,
        ...
        import easyfhe as torch
        import easyfhe._dynamo.config
        import easyfhe as torch
        import easyfhe._functorch.config
        ...
        import easyfhe as torch
        import easyfhe.nested._internal.nested_tensor
    ...
    def _validate_cache_key(
        ...
        reasonable.
        """
        from easyfhe._higher_order_ops.utils import registered_hop_fake_fns
    ...
    def _prep_args_for_hash(
        ...
        """
        from easyfhe._higher_order_ops.auto_functionalize import (
            FunctionalCallableWithEpilogue,
        )
        from easyfhe._higher_order_ops.utils import SubgraphCallableWrapper
    ...
    def _get_output_info_for_cache_entry(
        ...
        from easyfhe.fx.experimental.symbolic_shapes import GuardOnDataDependentSymNode
    ...
    def _make_cache_entry(
        ...
        """
        from easyfhe._higher_order_ops.utils import registered_hop_fake_fns
        from easyfhe.fx.experimental.symbolic_shapes import has_free_unbacked_symbols
    ...
    def _maybe_infer_fake(
        ...
        from easyfhe._subclasses.fake_utils import _check_fake_real_tensors
    ...
    def _maybe_infer_fake_kernel_from_pytree_out(
        ...
        """
        from easyfhe._subclasses.fake_utils import _check_alias_info
    ...
    def _dispatch_impl(
        ...
        from easyfhe._decomp import meta_table
    ...
    def create_symbolic_nested_int(
        ...
        import easyfhe as torch
        import easyfhe.nested._internal.nested_tensor
        from easyfhe.nested._internal.nested_int import NestedIntNode
...
def _validate_symbolic_output_for_caching(
    ...
    4. We could use the proxy to track "how" the SymNodes were computed and when
       ...
       build them.
    """
    from easyfhe.fx.experimental.symbolic_shapes import _iterate_exprs, _iterate_nodes
...
from easyfhe._subclasses.fake_impls import (  # noqa: F401
