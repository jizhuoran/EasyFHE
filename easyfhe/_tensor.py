...
import easyfhe._C as _C
from easyfhe._namedtensor_internals import (
...
class Tensor(torch._C.TensorBase):
    ...
    def _reduce_ex_internal(self, proto):
        ...
        from easyfhe.utils.hooks import warn_if_has_hooks
    ...
    def register_hook(self, hook):
        ...
        from easyfhe.utils.hooks import RemovableHandle
    ...
    def solve(self, other):
        from easyfhe._linalg_utils import solve

        return solve(self, other)

    def lstsq(self, other):
        from easyfhe._linalg_utils import lstsq

        return lstsq(self, other)

    def eig(self, eigenvectors=False):
        from easyfhe._linalg_utils import eig

        return eig(self, eigenvectors=eigenvectors)

    def symeig(self, eigenvectors=False):
        from easyfhe._linalg_utils import _symeig
    ...
    def __len__(self):
        ...
        if getattr(torch._C, "_get_tracing_state", lambda: False)():
            warnings.warn(
    ...
    def __dlpack_device__(self) -> tuple[enum.IntEnum, int]:
        ...
        from easyfhe.utils.dlpack import DLDeviceType
