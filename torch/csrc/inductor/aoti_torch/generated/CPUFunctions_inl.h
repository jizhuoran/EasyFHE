...
TORCH_API at::Tensor mul_pt_broadcast(const at::Tensor & self, const at::Tensor & in_b, const at::Tensor & mod, const at::Tensor & barret_mu, int64_t cur_limbs);
TORCH_API at::Tensor mul_pt_pairwise(const at::Tensor & self, const at::Tensor & in_b, const at::Tensor & mod, const at::Tensor & barret_mu, int64_t cur_limbs);
TORCH_API at::Tensor add_pt_broadcast(const at::Tensor & self, const at::Tensor & in_b, const at::Tensor & mod, int64_t cur_limbs);
TORCH_API at::Tensor add_pt_pairwise(const at::Tensor & self, const at::Tensor & in_b, const at::Tensor & mod, int64_t cur_limbs);
...
TORCH_API at::Tensor extend_ciphertext(const at::Tensor & self, const at::Tensor & input, int64_t N, int64_t L0, int64_t L, int64_t composite_degree, int64_t qjProduct, const at::Tensor & qj, const at::Tensor & qhat_inv_modqj, const at::Tensor & qjProductD, const at::Tensor & qjProduct_mod, const at::Tensor & qjProduct_psinv, const at::Tensor & qj_psinv, const at::Tensor & qhat_inv_modqj_mod, const at::Tensor & qhat_inv_modqj_psinv, const at::Tensor & qjProductD_psinv, const at::Tensor & primes, const at::Tensor & inverse_power_of_roots_div_two, const at::Tensor & inverse_scaled_power_of_roots_div_two, const at::Tensor & power_of_roots_shoup, const at::Tensor & power_of_roots, const at::Tensor & barret_ratio, const at::Tensor & barret_k);
...
TORCH_API ::std::vector<at::Tensor> encrypt(const at::Tensor & ptx, const at::Tensor & pk0, const at::Tensor & pk1, int64_t l, int64_t logn, int64_t nh, const at::Tensor & moduliP_scalar, const at::Tensor & moduliQ_scalar, const at::Tensor & primes, const at::Tensor & max_int_diffs, const at::Tensor & barret_ratio, const at::Tensor & barret_k, const at::Tensor & power_of_roots_shoup, const at::Tensor & power_of_roots);
