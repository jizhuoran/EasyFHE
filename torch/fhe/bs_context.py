    ...
    def __init__(self, content_map):
        ...
        for i in range(len(self.m_U0hatTPreFFT)):
            for j in range(len(self.m_U0hatTPreFFT[i])):
                ...
                print("NODE{} = cryptoContext.BsContext.m_U0hatTPreFFT[{}][{}]".format(self.m_U0hatTPreFFT[i][j].cipher_id, i, j))
        ...
        for i in range(len(self.m_U0PreFFT)):
            for j in range(len(self.m_U0PreFFT[i])):
                print("NODE{} = cryptoContext.BsContext.m_U0PreFFT[{}][{}]".format(self.m_U0PreFFT[i][j].cipher_id, i, j))
