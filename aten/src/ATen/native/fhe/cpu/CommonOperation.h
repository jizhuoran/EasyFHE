...
void switch_modulus(uint64_t* ptr,
                    uint64_t* res_ptr,
                    const Tensor& primes,
...
void vec_mod_batch(uint64_t* op1_ptr,
                   const Tensor& primes,
...
void const_mult_batch_(uint64_t* op1_ptr,
                       const Tensor& op2,
...
namespace fhe {
__uint128_t accumulate_in_modup(const uint64_t* ptr,
                                const int degree,
