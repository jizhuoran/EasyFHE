...
fhe.load_bootstrapping_info(specify_logSlots, cryptoContext)
result = fhe.homo_bootstrap(cipher, L0=cryptoContext.L, logSlots=specify_logSlots, cryptoContext=cryptoContext)
...
result1 = fhe.homo_bootstrap(result, L0=cryptoContext.L, logSlots=specify_logSlots, cryptoContext=cryptoContext)
print("gpu bootstrapp done!")
